...
function generatePower() {
  var powers = ["Telekinesis", "Water manipulation", "Fire manipulation", "Earth manipulation", "Air manipulation", "Telekinesis", "Teleportation", "Super speed", "Super strength", "Emotional manipulation", "Cloning", "Precognition", "Clairvoyance", "Lasers", "Invisibility", "Shapeshifting", "Flight", "Electric manipulation", "Telepathy", "Regeneration", "Healing", "Memory manipulation", "Time travel", "Illusions", "Animal control", "Portals", "Probabilty manipulation", "Shields", "Plant manipulation", "Sound manipulation", "Summoning", "Knowledge", "Gravity manipulation", "Meta powers", "Intangibility", "Technopathy", "Gadget creation", "Crystal manipulation", "Flow manipulation", "Cryokinesis", "Space manipulation", "Physiological adaptation", "Venomous phisiology", "Quills", "Gas breath", "Slime manipulation", "Force manipulation", "Mind control", "Time manipulation", "Disintegration", "Subspace generation", "Weapons", "Armor", "Acid manipulation", "Vapor manipulation", "Weather manipulation", "Matter generation", "Biology manipulation", "Enhanced perception", "Light manipulation", "Metal manipulation", "Size alteration", "Transformation", "Matter annihilation", "Invulnerability", "Mutation"];
  var butand = ["but", "and"];
  var modifiers = ["time", "absorption", "movement", "charging", "heat", "happiness", "fear", "metabolism", "theft", "repetition", "isolation", "crowds", "mass", "velocity", "feedback", "equivalence", "age", "range", "duration", "insanity", "memory", "pain", "self", "Thursday", "sleep", "visible mutation", "control", "precision", "scale", "instability", "knowledge", "damage", "speed", "versatility", "durability", "persistence", "transformation", "adaptation"];
  var sentence = "";
  ...
  function listProgress(auth) {
    ...
    sheets.spreadsheets.values.get(
      ...
      (err, res) => {
        ...
        if (rows.length) {
          var batches = rows.map(function (value, index) {
            return value[1];
          });
          for (var i = batches.length - 1; i > 0; i--) {
            if (batches[i]) break;
          }
          var chapters = rows.map(function (value, index) {
            return value[0];
          });
          ...
          var metadata = rows.map(function (value, index) {
            return value[5];
          });
          ...
          if (message.member) {
            var totaldata = rows.map(function (value, index) {
              return value[8];
            });
          ...
          //End of special case, I hate myself for this hackery
            ...
            const progressEmbed = new Discord.MessageEmbed()
              ...
              .addFields(
                ...
                {
                  name: "Last batch",
                  value: batches[i] + " (" + daysSince + " days ago)",
                  inline: true,
                },
                {
